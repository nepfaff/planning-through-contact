...
from planning_through_contact.geometry.box import Box2d, construct_2d_plane_from_points
...
def simple_rotations_test(use_sdp_relaxation: bool = True):
    ...
    moment_balance = eq(
        cross_2d(FINGER_POS, f_finger) + cross_2d(GROUND_CONTACT_POS, f_contact), 0
    )
